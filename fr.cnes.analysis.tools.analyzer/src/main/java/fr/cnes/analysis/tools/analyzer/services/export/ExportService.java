...
public class ExportService implements IExportService {
    ...
    public void export(List<CheckResult> pCheckResults, File pOutputFile,
                    ...
                    NoExtensionIndicatedException, IOException {
        final String method = "fr/cnes/analysis/tools/analyzer/services/export";
     ...
     * 
     * @see
     * fr.cnes.analysis.tools.analyzer.services.export.IExportService#getParameters(java.lang.
     * String)
     */
    @Override
     ...
     * 
     * @see
     * fr.cnes.analysis.tools.analyzer.services.export.IExportService#hasParameters(java.lang.
     * String)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see fr.cnes.analysis.tools.analyzer.services.export.IExportService#getAvailableFormats()
     */
    @Override
