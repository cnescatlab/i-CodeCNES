...
public class ImportService implements IImportService {
    ...
    public static final String EXPORT_EXTENSIONPOINT_ID = "fr/cnes/analysis/tools/analyzer/services/export";
     ...
     * 
     * @see
     * fr.cnes.analysis.tools.analyzer.services.export.IImportService#importResults(java.io.File)
     */
    @Override
