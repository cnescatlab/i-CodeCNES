...
/************************************************************************************************/
package fr.cnes.analysis.tools.analyzer.services.export.csv;
...
import fr.cnes.analysis.tools.analyzer.services.export.IExporter;

/**
 * This class is an attribute of the {@code ExtensionPoint} implementing
 * {@link IExporter} interface of the plugin
 * <i>fr.cnes.analysis.tools.analyzer.services.export</i>.
 * <p>
 * This class is also exported in the <i>fr.cnes.analysis.tools.analyzer.services.export.csv</i>
 * plugin and could be used as a service from any third.
 * </p>
 * <p>
 * This class is responsible of the fr.cnes.analysis.tools.analyzer.services.export in the format CSV of
...
public class ExporterCsv implements IExporter {
     ...
     * (non-Javadoc)
     * 
     * @see fr.cnes.analysis.tools.analyzer.services.export.IExport#hasParameters()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see fr.cnes.analysis.tools.analyzer.services.export.IExport#getParameters()
     */
    @Override
