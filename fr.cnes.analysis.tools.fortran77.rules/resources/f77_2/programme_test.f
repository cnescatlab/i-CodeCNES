...
! Author : Pierre Marighetto & José Manuel Lopez Alpanez
...
c Variables JAMAIS UTILISEES
		REAL nevUSED
		INTEGER nevUSED2
		DOUBLE PRECISION nevUSEDbefore
		INTEGER phantom
...
c Test d'expression avec variables de types multiples
		V= U + FA + INDICE - RESUL
...
c Vérification d'une boucle wait 		
		I = wait(J)
		if(I .lt. 0) stop 'wait : error'
...
c Test de la COM.FLOW.FilePath
		CHARACTER*20 accesFichier
		chaine = '../dossier/README.txt'
...
c NOK
		open(13,file='../dossier/README.txt')
		close(13)
c NOK		
		open(13,file='../dossier/README')
		close(13)
