...
package fr.cnes.analysis.tools.fortran77.rules.COM.FLOW.Abort;
...
import fr.cnes.analysis.tools.fortran77.rules.COMFLOWAbort;
...
public class TestCOMFLOWAbort {
    ...
    public final AbstractRule rule = new COMFLOWAbort();
