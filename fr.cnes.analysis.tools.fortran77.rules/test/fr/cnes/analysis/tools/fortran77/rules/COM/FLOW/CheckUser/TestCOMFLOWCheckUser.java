...
package fr.cnes.analysis.tools.fortran77.rules.COM.FLOW.CheckUser;
...
import fr.cnes.analysis.tools.fortran77.rules.COMFLOWCheckUser;
import fr.cnes.analysis.tools.fortran77.rules.TestUtils;

public class TestCOMFLOWCheckUser {
    ...
    public final static String[] LOCATIONS     = { "PROGRAM MAIN" };
    public final AbstractRule    rule          = new COMFLOWCheckUser();
