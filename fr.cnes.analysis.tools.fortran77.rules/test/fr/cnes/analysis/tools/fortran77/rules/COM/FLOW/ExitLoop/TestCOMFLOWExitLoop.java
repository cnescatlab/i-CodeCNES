...
package fr.cnes.analysis.tools.fortran77.rules.COM.FLOW.ExitLoop;
...
import fr.cnes.analysis.tools.fortran77.rules.COMFLOWExitLoop;
...
public class TestCOMFLOWExitLoop {
    ...
    public final static int[] LINES = {5, 9, 15, 17};
    public final static String[] LOCATIONS = {"FUNCTION TEST",
