...
package fr.cnes.analysis.tools.fortran77.rules.COM.INST.GoTo;
...
import fr.cnes.analysis.tools.fortran77.rules.COMINSTGoTo;
...
public class TestCOMINSTGoTo {
    ...
    public final AbstractRule rule = new COMINSTGoTo();
