...
package fr.cnes.analysis.tools.fortran77.rules.COM.NAME.Homonymy;
...
import fr.cnes.analysis.tools.fortran77.rules.COMNAMEHomonymy;
...
public class TestCOMNAMEHomonymy {
    ...
    public final static int[] LINES = {7, 25, 29};
    public final static String[] LOCATIONS = {"function f1", "subroutine s1",
            "function f3"};
