...
package fr.cnes.analysis.tools.fortran77.rules.F77.BLOC.Common;
...
import fr.cnes.analysis.tools.fortran77.rules.F77BLOCCommon;
import fr.cnes.analysis.tools.fortran77.rules.TestUtils;

/**
 * This class aims to test F77.BLOC.Common rule. There are 2 functions in this
 ...
 * 
 */
public class TestF77BLOCCommon {

    public final static String ERROR_FILE = "error.f";
    public final static String NO_ERROR_FILE = "noError.f";
    public final static int[] LINES = {6, 7, 26};
    public final static String[] LOCATIONS = {"PROGRAM ESSAI",
            "PROGRAM ESSAI", "SUBROUTINE MY_SUB1"};
    public final AbstractRule rule = new F77BLOCCommon();
