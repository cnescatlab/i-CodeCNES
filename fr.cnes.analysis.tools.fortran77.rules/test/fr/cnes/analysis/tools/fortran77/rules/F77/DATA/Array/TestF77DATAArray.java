...
package fr.cnes.analysis.tools.fortran77.rules.F77.DATA.Array;
...
import fr.cnes.analysis.tools.fortran77.rules.F77DATAArray;
 ...
 * 
 */
public class TestF77DATAArray {

    public final static String ERROR_FILE = "error.f";
    public final static String NO_ERROR_FILE = "noError.f";
    public final static int[] LINES = { 68, 70 };
    public final static String[] LOCATIONS = { "SUBROUTINE MOYENNE", "SUBROUTINE MOYENNE" };
    public final AbstractRule rule = new F77DATAArray();
    ...
    public void testRunWithError() {
        ...
        try {
            ...
            for (final Violation value : list) {
                ...
                assertTrue(
                        "Violation " + index.toString() + " has wrong location : " + location
