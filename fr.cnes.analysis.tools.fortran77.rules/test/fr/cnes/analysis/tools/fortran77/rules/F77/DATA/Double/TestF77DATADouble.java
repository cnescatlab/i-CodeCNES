...
package fr.cnes.analysis.tools.fortran77.rules.F77.DATA.Double;
...
import fr.cnes.analysis.tools.fortran77.rules.F77DATADouble;
 ...
 * 
 */
public class TestF77DATADouble {

    public final static String ERROR_FILE = "error.f";
    public final static String NO_ERROR_FILE = "noError.f";
    public final static int[] LINES = {17};
    public final static String[] LOCATIONS = {"SUBROUTINE"};
    public final AbstractRule rule = new F77DATADouble();
