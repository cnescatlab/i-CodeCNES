...
package fr.cnes.analysis.tools.fortran77.rules.F77.DATA.Initialiasation;
...
import fr.cnes.analysis.tools.fortran77.rules.F77DATAInitialisation;
 ...
 * 
 */
public class TestF77DATAInitialisation {

    public final static String ERROR_FILE = "error.f";
    public final static String NO_ERROR_FILE = "noError.f";
    public final static int[] LINES = {12, 13, 14, 15, 18};
    public final static String[] LOCATIONS = {"PROGRAM", "PROGRAM", "PROGRAM",
            "PROGRAM", "PROGRAM"};
    public final AbstractRule rule = new F77DATAInitialisation();
