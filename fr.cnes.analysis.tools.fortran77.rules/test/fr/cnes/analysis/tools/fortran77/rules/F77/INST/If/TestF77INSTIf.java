...
package fr.cnes.analysis.tools.fortran77.rules.F77.INST.If;
...
import fr.cnes.analysis.tools.fortran77.rules.F77INSTIf;
...
public class TestF77INSTIf {
    ...
    public final AbstractRule rule = new F77INSTIf();
