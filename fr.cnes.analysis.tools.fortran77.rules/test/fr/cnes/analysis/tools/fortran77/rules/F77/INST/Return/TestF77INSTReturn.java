...
package fr.cnes.analysis.tools.fortran77.rules.F77.INST.Return;
...
import fr.cnes.analysis.tools.fortran77.rules.F77INSTReturn;
import fr.cnes.analysis.tools.fortran77.rules.TestUtils;

/**
 * This class aims to test Tr.SubReturn rule. There are 2 functions in this
 ...
 * 
 */
public class TestF77INSTReturn {

    public final static String ERROR_FILE = "error.f";
    public final static String NO_ERROR_FILE = "noError.f";
    public final static int[] LINES = {27};
    public final static String[] LOCATIONS = {"SUBROUTINE carre_cube"};
    public final AbstractRule rule = new F77INSTReturn();
