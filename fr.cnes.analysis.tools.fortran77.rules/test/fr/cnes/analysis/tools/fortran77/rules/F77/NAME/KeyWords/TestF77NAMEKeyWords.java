...
package fr.cnes.analysis.tools.fortran77.rules.F77.NAME.KeyWords;
...
import fr.cnes.analysis.tools.fortran77.rules.F77NAMEKeyWords;
 ...
 * 
 */
public class TestF77NAMEKeyWords {

    public final static String ERROR_FILE = "error.f";
    public final static String NO_ERROR_FILE = "noError.f";
    public final static int[] LINES = {13, 14, 15, 16, 17};
    public final static String[] LOCATIONS =
            {"PROGRAM ESSAI", "PROGRAM ESSAI", "PROGRAM ESSAI",
                    "PROGRAM ESSAI", "PROGRAM ESSAI"};
    public final AbstractRule rule = new F77NAMEKeyWords();
