...
package fr.cnes.analysis.tools.fortran77.rules.F77.PROTO.Declaration;
...
import fr.cnes.analysis.tools.fortran77.rules.F77PROTODeclaration;
import fr.cnes.analysis.tools.fortran77.rules.TestUtils;

/**
 * This class aims to test F77.NAME.KeyWords rule. There are 2 functions in
 * this class. The first one verifies that an error in a file is detected
 * whenever there is one, the other verifies that nothing is detected when
 * there's no error.
 * 
 */
public class TestF77PROTODeclaration {

    public final static String ERROR_FILE = "error.f";
    public final static String NO_ERROR_FILE = "noError.f";
    public final static int[] LINES = {24, 29};
    public final static String[] LOCATIONS = {"PROGRAM", "PROGRAM"};
    public final AbstractRule rule = new F77PROTODeclaration();
