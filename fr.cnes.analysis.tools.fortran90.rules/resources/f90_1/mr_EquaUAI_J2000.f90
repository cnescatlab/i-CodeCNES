...
!     remplacement math_mslib  par une sélection de int_constantes
...
character(len=pm_longueur_info_utilisateur), parameter :: info_utilisateur = &
                     '@(#) Fichier MSLIB mr_EquaUAI_J2000.f90: derniere modification V6.13 >'

! Ne pas toucher a la ligne suivante
character(len=pm_longueur_rcs_id), parameter :: rcs_id =' $Id: mr_EquaUAI_J2000.f90 362 2013-02-15 18:01:28Z bbjc $ '
