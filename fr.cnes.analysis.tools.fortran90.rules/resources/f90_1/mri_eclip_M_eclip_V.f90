...
!************************************************************************
!
! But:  Calcul de la matrice de passage du repere ECLIPtique MOYen a T1 au repere ECLIPtique VRAI a T2.
! ===
!
...
!$Historique
! ==========
!   + Version 1.0 (SP 275 ed01 rev00): creation a partir de la routine MRCCMV de la MSLIB f77
...
integer                        :: modele_precession, modele_nutation ! indicateurs des modeles de precession et de nutation
                                                                     ! correspondants a "model" en entree.

character(len=pm_longueur_info_utilisateur), parameter :: info_utilisateur = &
                     '@(#) Fichier MSLIB mri_eclip_M_eclip_V.f90: derniere modification V6.13 >'

intrinsic cos, sin

! Ne pas toucher a la ligne suivante
character(len=pm_longueur_rcs_id), parameter :: rcs_id =' $Id: mri_eclip_M_eclip_V.f90 362 2013-02-15 18:01:28Z bbjc $ '
...
if (model == pm_lieske_wahr) then
   ...
   ! calcul de la matrice de passage du repere ecliptique moyen a t1 au repere ecliptique vrai a t2
