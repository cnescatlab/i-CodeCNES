...
!************************************************************************
!
! But:  Calcul de la matrice de passage du repere ECLIPtique VRAI a T1 au repere EQUAtorial VRAI a T2.
! ===
!
...
!$Historique
! ==========
!   + Version 1.0 (SP 277 ed01 rev00): creation a partir de la routine MRCQVV de la MSLIB f77
...
type(tm_nuta)                  :: nuta                             ! nutation en longitude
type(tm_code_retour)           :: code_retour, code_retour_local
integer                        :: modele_nutation                  ! indicateur du modele de nutation correspondant a "model"

character(len=pm_longueur_info_utilisateur), parameter :: info_utilisateur = &
                     '@(#) Fichier MSLIB mri_eclip_V_equa_V.f90: derniere modification V6.13 >'

intrinsic sin, cos

! Ne pas toucher a la ligne suivante
character(len=pm_longueur_rcs_id), parameter :: rcs_id =' $Id: mri_eclip_V_equa_V.f90 362 2013-02-15 18:01:28Z bbjc $ '
...
if (model == pm_lieske_wahr) then 
   ...
   ! calcul de la matrice de passage du repere ecliptique vrai a t1 au repere equatorial vrai a t2
   ...
   call mri_eclip_M_equa_V (model, jul1950_t1, jul1950_t2, mat_pass2, retour)
   ! pas de test de retour car il ne peut etre que nul (controles deja effectues)
