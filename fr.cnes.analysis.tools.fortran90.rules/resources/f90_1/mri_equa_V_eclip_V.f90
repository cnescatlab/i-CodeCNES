...
!************************************************************************
!
! But:  Calcul de la matrice de passage du repere EQUAtorial VRAI a T1 au repere ECLIPtique VRAI a T2.
! ===
!
...
!$Historique
! ==========
!   + Version 1.0 (SP 271 ed01 rev00): creation a partir de la routine MRQCVV de la MSLIB f77
...
character(len=pm_longueur_info_utilisateur), parameter :: info_utilisateur = &
                     '@(#) Fichier MSLIB mri_equa_V_eclip_V.f90: derniere modification V6.13 >'

! Ne pas toucher a la ligne suivante
character(len=pm_longueur_rcs_id), parameter :: rcs_id =' $Id: mri_equa_V_eclip_V.f90 362 2013-02-15 18:01:28Z bbjc $ '
...
if (model == pm_lieske_wahr) then
   ...
   ! calcul de la matrice de passage du repere equatorial vrai a t1 au repere ecliptique vrai a t2
   ! avec le modele de precession de Lieske et le modele de nutation de Wahr (epoque de base : J2000)

   ! ===============================================================
   ! calcul de la matrice de passage du repere ecliptique vrai a t2
   ! au repere  equatorial vrai a t1
   ! ===============================================================

   call mri_eclip_V_equa_V (model, jul1950_t2, jul1950_t1, mat_pass1, retour)
