...
package fr.cnes.analysis.tools.fortran90.rules.COM.FLOW.FileExistence;
...
import fr.cnes.analysis.tools.fortran90.rules.COMFLOWFileExistence;
...
public class TestCOMFLOWFileExistence {
    ...
    public final static int[] LINES = {5, 7, 28};
    public final static String[] LOCATIONS = {"PROGRAM ESSAI",
            "PROGRAM ESSAI", "PROGRAM ESSAI"};
    public final AbstractRule rule = new COMFLOWFileExistence();
