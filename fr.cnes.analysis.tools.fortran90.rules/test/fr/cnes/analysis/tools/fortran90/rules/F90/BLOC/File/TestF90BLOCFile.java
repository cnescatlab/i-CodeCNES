...
package fr.cnes.analysis.tools.fortran90.rules.F90.BLOC.File;
...
import fr.cnes.analysis.tools.fortran90.rules.F90BLOCFile;
...
public class TestF90BLOCFile {
    ...
    public final AbstractRule rule = new F90BLOCFile();
