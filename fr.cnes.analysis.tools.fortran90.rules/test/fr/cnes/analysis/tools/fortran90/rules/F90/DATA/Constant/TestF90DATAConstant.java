...
package fr.cnes.analysis.tools.fortran90.rules.F90.DATA.Constant;
...
import fr.cnes.analysis.tools.fortran90.rules.F90DATAConstant;
 ...
 * 
 */
public class TestF90DATAConstant {

    public final static String ERROR_FILE = "error.f";
    public final static String NO_ERROR_FILE = "noError.f";
    public final static int[] LINES = {64, 86};
    public final static String[] LOCATIONS = {"FUNCTION FUNC_1","FUNCTION FUNC_2"};
    public final AbstractRule rule = new F90DATAConstant();
