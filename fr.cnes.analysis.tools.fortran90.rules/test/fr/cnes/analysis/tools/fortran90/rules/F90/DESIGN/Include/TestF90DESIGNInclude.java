...
package fr.cnes.analysis.tools.fortran90.rules.F90.DESIGN.Include;
...
import fr.cnes.analysis.tools.fortran90.rules.F90DESIGNInclude;
 ...
 * 
 */
public class TestF90DESIGNInclude {
    ...
    public AbstractRule rule = new F90DESIGNInclude();
    ...
    public void testRunWithoutError() {
        try {
            ...
            // Defining file in the rule instantiation.
            this.rule = new F90DESIGNInclude();
            this.rule.setContribution(TestUtils.getContribution("", ""));
            this.rule.setInputFile(file);
