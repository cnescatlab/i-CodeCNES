...
package fr.cnes.analysis.tools.fortran90.rules.F90.ERR.OpenRead;
...
import fr.cnes.analysis.tools.fortran90.rules.F90ERROpenRead;
import fr.cnes.analysis.tools.fortran90.rules.TestUtils;

/**
 * This class aims to test Err.OpenRead rule. There are 2 functions in this
 ...
 * 
 */
public class TestF90ERROpenRead {

    public final static String ERROR_FILE = "error.f";
    public final static String NO_ERROR_FILE = "noError.f";
    public final static int[] LINES = {27, 32, 39, 42};
    public final static String[] LOCATIONS =
            {"PROGRAM ESSAI", "PROGRAM ESSAI", "PROGRAM ESSAI", "PROGRAM ESSAI"};
    public final AbstractRule rule = new F90ERROpenRead();
