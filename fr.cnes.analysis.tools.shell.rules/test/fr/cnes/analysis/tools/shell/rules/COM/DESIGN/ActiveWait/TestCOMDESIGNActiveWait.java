...
package fr.cnes.analysis.tools.shell.rules.COM.DESIGN.ActiveWait;
...
import fr.cnes.analysis.tools.shell.rules.COMDESIGNActiveWait;
 ...
 * 
 */
public class TestCOMDESIGNActiveWait {
    ...
    public final AbstractRule    rule          = new COMDESIGNActiveWait();
