...
package fr.cnes.analysis.tools.shell.rules.COM.FLOW.Recursion;
...
import fr.cnes.analysis.tools.shell.rules.COMFLOWRecursion;
 ...
 * 
 */
public class TestCOMFLOWRecursion {
    ...
    public final AbstractRule rule = new COMFLOWRecursion();
