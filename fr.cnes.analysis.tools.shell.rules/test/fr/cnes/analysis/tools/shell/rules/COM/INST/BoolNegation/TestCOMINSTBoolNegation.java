...
package fr.cnes.analysis.tools.shell.rules.COM.INST.BoolNegation;
...
public class TestCOMINSTBoolNegation {
    ...
    public final static String[] LOCATIONS = {"MAIN PROGRAM", "MAIN PROGRAM", "MAIN PROGRAM", "MAIN PROGRAM", "MAIN PROGRAM", "test1", "test", "test"};
