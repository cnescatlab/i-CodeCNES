...
package fr.cnes.analysis.tools.shell.rules.COM.INST.CodeComment;
...
public class TestCOMINSTCodeComment {
    ...
    public final static String[] LOCATIONS = {"MAIN PROGRAM", "MAIN PROGRAM", "MAIN PROGRAM", "MAIN PROGRAM", "MAIN PROGRAM", "MAIN PROGRAM", "MAIN PROGRAM", "MAIN PROGRAM", "MAIN PROGRAM"};
