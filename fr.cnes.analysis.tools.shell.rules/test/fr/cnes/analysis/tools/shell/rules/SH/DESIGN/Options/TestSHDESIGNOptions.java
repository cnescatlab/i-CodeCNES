...
package fr.cnes.analysis.tools.shell.rules.SH.DESIGN.Options;
...
import fr.cnes.analysis.tools.shell.rules.SHDESIGNOptions;
 ...
 * 
 */
public class TestSHDESIGNOptions {
    ...
    public final AbstractRule rule = new SHDESIGNOptions();
