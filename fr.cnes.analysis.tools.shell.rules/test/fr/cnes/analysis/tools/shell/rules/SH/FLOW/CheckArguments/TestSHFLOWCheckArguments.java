...
package fr.cnes.analysis.tools.shell.rules.SH.FLOW.CheckArguments;
...
import fr.cnes.analysis.tools.shell.rules.SHFLOWCheckArguments;
 ...
 * 
 */
public class TestSHFLOWCheckArguments {
    ...
    public final static String[] LOCATIONS = {"ma_fonction_affine"};
    public final AbstractRule rule = new SHFLOWCheckArguments();
