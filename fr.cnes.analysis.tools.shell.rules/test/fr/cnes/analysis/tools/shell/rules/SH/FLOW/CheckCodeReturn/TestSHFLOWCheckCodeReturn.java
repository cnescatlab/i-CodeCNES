...
package fr.cnes.analysis.tools.shell.rules.SH.FLOW.CheckCodeReturn;
...
import fr.cnes.analysis.tools.shell.rules.SHFLOWCheckCodeReturn;
 ...
 * 
 */
public class TestSHFLOWCheckCodeReturn {
    ...
    public final static String[] LOCATIONS = {"factorial","factorial","factorial","factorial","nettoyer_repertoire","nettoyer_repertoire","nettoyer_repertoire"};
    public final AbstractRule rule = new SHFLOWCheckCodeReturn();
