...
package fr.cnes.analysis.tools.shell.rules.SH.FLOW.CheckUser;
...
import fr.cnes.analysis.tools.shell.rules.SHFLOWCheckUser;
 ...
 * 
 */
public class TestSHFLOWCheckUser {
    ...
    public final AbstractRule rule = new SHFLOWCheckUser();
