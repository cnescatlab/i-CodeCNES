...
package fr.cnes.analysis.tools.shell.rules.SH.INST.Interpreter;
 ...
 * 
 */
public class TestSHINSTInterpreter {
     ...
     */
    @Test
    public void testRunWithoutErrorWithFile1() {
        try {
            // Initializing rule and getting error file.
     ...
     */
    @Test
    public void testRunWithoutErrorWithFile2() {
        try {
            // Initializing rule and getting error file.
            final IPath file = new Path(this.getClass().getResource(NO_ERROR_FILE2).getPath());
