...
package fr.cnes.analysis.tools.shell.rules.SH.SYNC.Signals;
...
import fr.cnes.analysis.tools.shell.rules.SHSYNCSignals;
 ...
 * 
 */
public class TestSHSYNCSignals {
    ...
    public final AbstractRule rule = new SHSYNCSignals();
