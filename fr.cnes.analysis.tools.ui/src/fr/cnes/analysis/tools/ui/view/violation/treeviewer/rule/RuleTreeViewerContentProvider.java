...
public class RuleTreeViewerContentProvider implements ITreeContentProvider {
	...
	public Object[] getChildren(final Object parentElement) {
		...
		if (parentElement instanceof FileRuleDescriptor) {
			...
			final List<FunctionRuleDescriptor> mVals = ((FileRuleDescriptor) parentElement).getDescriptors();
			...
			final List<FileRuleDescriptor> mVals = ((RuleDescriptor) parentElement).getDescriptors();
