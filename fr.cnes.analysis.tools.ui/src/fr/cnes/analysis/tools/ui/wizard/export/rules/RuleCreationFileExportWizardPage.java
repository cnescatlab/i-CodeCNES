...
/**
 * This class is an adaptive {@link WizardNewFileCreationPage} which format is pending the selection
 * of the user in the previous page {@link RuleExportWizard}.
 * 
 * <p>
...
public class RuleCreationFileExportWizardPage extends WizardNewFileCreationPage {
  ...
  /**
   * This function update all field of the page and the file format pending the
   * {@code pRequestedFormat} value.
   * 
   * <p>
   * This class is currently called by the previous page {@link RuleExportWizardPage} every time an
   * user select an export format for his file.
   * </p>
   * 
