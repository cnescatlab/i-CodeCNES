...
public final class ConfigurationService {
    ...
    /**
     * @param configurationName The configuration to retrieve data from
     * @return A {@link ConfigurationContainer} containing all data contained
     * for <code>configurationName</code>.
     * @throws NullContributionException when configuration requested do not exist or is trying to
