 ...
 */
public class TestAllShellRules implements ICodeCheckerTester {
    ...
    public static Object[][] data() {
        return new Object[][]{
                ...
                {"/COM/DESIGN/ActiveWait/error.sh", "/COM/DESIGN/ActiveWait/noError.sh", new int[]{9, 21, 22, 26}, new String[]{"MAIN PROGRAM", "readNum", "readNum", "MAIN PROGRAM"}, COMDESIGNActiveWait.class},
                ...
                {"/empty.sh", "/COM/PRES/Header/noError.sh", new int[]{0}, new String[]{"MAIN PROGRAM"}, COMPRESHeader.class},
