...
package fr.cnes.analysis.tools.fortran77.rules.COM.DATA.LoopCondition;
...
import fr.cnes.analysis.tools.fortran77.rules.COMDATALoopCondition;
...
public class TestCOMDATALoopCondition {
    ...
    public final static String[] LOCATIONS = {"MAIN PROGRAM", "MAIN PROGRAM",
            "MAIN PROGRAM", "MAIN PROGRAM", "MAIN PROGRAM", "MAIN PROGRAM", "FUNCTION TEST"};
