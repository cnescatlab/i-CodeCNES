...
package fr.cnes.analysis.tools.fortran77.rules.COM.DESIGN.Alloc;
...
import fr.cnes.analysis.tools.fortran77.rules.COMDESIGNAlloc;
...
public class TestCOMDESIGNAlloc {
    ...
    public final static String[] LOCATIONS = {"function f1",
            								  "subroutine s2"};
