...
package fr.cnes.analysis.tools.fortran77.rules.COM.FLOW.CheckCodeReturn;
...
import fr.cnes.analysis.tools.fortran77.rules.COMFLOWCheckCodeReturn;
import fr.cnes.analysis.tools.fortran77.rules.TestUtils;

public class TestCOMFLOWCheckCodeReturn {
    ...
    public final AbstractRule rule = new COMFLOWCheckCodeReturn();
