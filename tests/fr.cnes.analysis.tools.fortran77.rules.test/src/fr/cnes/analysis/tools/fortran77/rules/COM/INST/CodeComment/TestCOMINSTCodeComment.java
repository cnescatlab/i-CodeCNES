...
package fr.cnes.analysis.tools.fortran77.rules.COM.INST.CodeComment;
...
import fr.cnes.analysis.tools.fortran77.rules.COMINSTCodeComment;
 ...
 * 
 */
public class TestCOMINSTCodeComment {

    public final static String ERROR_FILE = "error.f";
    public final static String NO_ERROR_FILE = "noError.f";
    public final static int[] LINES = {14,17};
    public final static String[] LOCATIONS = {"subroutine mpi_IO_e_us76",
            "subroutine mpi_IO_e_us76", "subroutine mpi_IO_e_us76"};
