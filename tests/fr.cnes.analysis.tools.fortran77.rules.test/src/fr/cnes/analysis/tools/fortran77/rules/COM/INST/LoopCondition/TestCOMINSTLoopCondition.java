...
package fr.cnes.analysis.tools.fortran77.rules.COM.INST.LoopCondition;
...
import fr.cnes.analysis.tools.fortran77.rules.COMINSTLoopCondition;
 ...
 * 
 */
public class TestCOMINSTLoopCondition {
    ...
    public final AbstractRule rule = new COMINSTLoopCondition();
