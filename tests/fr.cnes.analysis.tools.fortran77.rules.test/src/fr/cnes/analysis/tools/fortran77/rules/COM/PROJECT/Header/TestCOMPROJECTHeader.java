...
/**
 * This class aims to test Pr.CartStd rule. There are 2 functions in this class.
...
public class TestCOMPROJECTHeader {
	...
	public final static String[] LOCATIONS = { "No file header existing", "FUNCTION F" };
	public AbstractChecker rule = new COMPROJECTHeader();
