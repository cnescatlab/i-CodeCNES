...
package fr.cnes.analysis.tools.fortran77.rules.COM.PROJECT.Header;
...
import fr.cnes.analysis.tools.fortran77.rules.COMPROJECTHeader;
import fr.cnes.analysis.tools.fortran77.rules.TestUtils;

/**
 * This class aims to test Pr.CartStd rule. There are 2 functions in this
 ...
 * 
 */
public class TestCOMPROJECTHeader {

    public final static String ERROR_FILE = "error.f";
    public final static String NO_ERROR_FILE = "noError.f";
    public final static int[] LINES = {0, 11};
    public final static String[] LOCATIONS = {"No file header existing",
            "FUNCTION F"};
    public AbstractRule rule = new COMPROJECTHeader();
