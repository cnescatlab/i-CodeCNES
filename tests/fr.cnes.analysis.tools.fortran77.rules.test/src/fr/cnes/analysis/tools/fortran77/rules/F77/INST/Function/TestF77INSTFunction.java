...
package fr.cnes.analysis.tools.fortran77.rules.F77.INST.Function;
...
import fr.cnes.analysis.tools.fortran77.rules.F77INSTFunction;
import fr.cnes.analysis.tools.fortran77.rules.TestUtils;

/**
 * This class aims to test F77.INST.Function rule. There are 2 functions in
 ...
 * 
 */
public class TestF77INSTFunction {

    public final static String ERROR_FILE = "error.f";
    public final static String NO_ERROR_FILE = "noError.f";
    public final static int[] LINES = {7};
    public final static String[] LOCATIONS = {"FUNCTION"};
    public final AbstractRule rule = new F77INSTFunction();
