...
package fr.cnes.analysis.tools.fortran77.rules.F77.INST.Save;
...
import fr.cnes.analysis.tools.fortran77.rules.F77INSTSave;
...
public class TestF77INSTSave {
    ...
    public final AbstractRule rule = new F77INSTSave();
