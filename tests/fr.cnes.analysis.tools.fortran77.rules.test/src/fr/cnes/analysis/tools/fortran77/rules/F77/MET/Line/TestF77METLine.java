...
package fr.cnes.analysis.tools.fortran77.rules.F77.MET.Line;
...
import fr.cnes.analysis.tools.fortran77.rules.F77METLine;
...
public class TestF77METLine {
    ...
    public final static String[] LOCATIONS = {"PROGRAM F77_Pr_LongLigne"};
    public final AbstractRule rule = new F77METLine();
