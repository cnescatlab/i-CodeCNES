...
package fr.cnes.analysis.tools.fortran77.rules.F77.REF.Open;
...
import fr.cnes.analysis.tools.fortran77.rules.F77REFOpen;
...
public class TestF77REFOpen {
    ...
    public final static String[] LOCATIONS =
            {"MAIN PROGRAM"};
    public final AbstractRule rule = new F77REFOpen();
