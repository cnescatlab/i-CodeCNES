...
public class TestGlobal_3 {
  ...
  public void runGlobalTest() {
    try {
      ...
      File fileResult = new File("resources/globalTest_3.txt");
      // fileResult.deleteOnExit();
      /**
       * File to compare with fileResult. This file is the verified version of the execution
       **/
      File fileResultValidated = new File("resources/globalTestValidated_3.txt");
      ...
      TestGlobal_3.list = analysis.applyRules(listFiles, extensionIds, null);
