...
!
!$Resume
!  Modèles d'Atmosphère martien EMCD 4.3
!
!$Description
! Ce module contient la version 4.3 du modèle EMCD (European Martian
! Climate Database) :
! - routine cps_atmemcd_43
! 
!$Auteur
!  Cédric MARTEL (ATOS Origin)
!
!$Version
!  $Id: cps_modele_emcd43.F90 379 2013-02-22 16:59:49Z ffsm $
!
!$Historique
!  $Log: cps_modele_emcd43.F90,v $
...
!
!  Revision 1.9  2010/10/21 13:46:21  ogarat
!  VERSION::AQ::21/10/2010:Ajout du fin historique
!
!  Revision 1.8  2009/01/13 10:50:25  cml
!  FA-ID 1160 : Deplacement de l init. des unites logiques
!
!  Revision 1.7  2008/12/22 11:02:16  cml
!  AQ : Ajout d une desallocation manquante
!
!  Revision 1.6  2008/12/19 15:49:10  cml
!  FA-ID 1160 : Correction des attributs inout pour les unites logiques lors de l appel a open
!
!  Revision 1.5  2008/10/13 08:04:32  cml
!  DM-ID 1091 : Initialisation des tableaux avant les appels a NetCDF
!
!  Revision 1.4  2008/08/11 09:32:37  cml
!  DM-ID 1091 : Correction cartouche
!
!  Revision 1.3  2008/08/04 15:35:06  cml
!  DM-ID 1091 : Initialisation des tableaux avant les appels a NetCDF
!
!  Revision 1.2  2008/07/29 08:02:39  cml
!  DM-ID 1091 : Passage des variables reelles du modele en pm_reel
!
!  Revision 1.1  2008/07/23 10:01:29  cml
!  DM-ID 1091 : Mise en conf du modele EMCD 4.3
!
!
!$FinHistorique
!
...
!***********************************************************************
  ...
  ! Accès à la base pour chemin par defaut d'accès aux données de l'EMCD43
  use cps_utilisateur 
  use netcdf_f90
...
! SVN Source File Id
  character(len=256), private :: SVN_VER =  '$Id: cps_modele_emcd43.F90 379 2013-02-22 16:59:49Z ffsm $'

  interface cps_atmemcd_43
...
!***********************************************************************
  ...
  ! La routine de désallocation de la mémoire est cps_atmemcd_43_close
...
100   continue
      ...
      if (lendataset.eq.0) then 
         ...
         ier = cps_getFichierModele("atmosphere", "EMCD4_3", dataset, &
           rep=.true.)
         if ( MSP_gen_messages ("cps_atmemcd_43") ) then
            return
         end if
         dataset2 = dataset 
...
!  La désallocation se fait par un appel a cps_modele_emcd43_close()
! -------------------------------------------
...
!ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
      subroutine getsi(xz,zkey,oroheight,areoid,ps,sigma, &
         ...
         R_gcm,temp_gcm,zareoid,zradius,zsurface,zpressure,zmradius, &
         sheight)
...
!
    ...
    subroutine cps_atmemcd_43_close ()
!***********************************************************************
!$<AM-V2.0>                                                            *
!$Type                                                                 *
!     Subroutine                                                       *
...
!***********************************************************************
    ...
    end subroutine cps_atmemcd_43_close

    end module cps_modele_emcd43
