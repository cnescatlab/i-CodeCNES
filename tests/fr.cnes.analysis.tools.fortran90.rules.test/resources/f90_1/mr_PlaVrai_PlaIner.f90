...
! Modules
! =======
use int_chgmnt_reperes, only : mt_ref_iner
...
character(len=pm_longueur_info_utilisateur), parameter :: info_utilisateur = &
                     '@(#) Fichier MSLIB mr_PlaVrai_PlaIner.f90: derniere modification V6.13 >'

! Ne pas toucher a la ligne suivante
character(len=pm_longueur_rcs_id), parameter :: rcs_id =' $Id: mr_PlaVrai_PlaIner.f90 362 2013-02-15 18:01:28Z bbjc $ '
