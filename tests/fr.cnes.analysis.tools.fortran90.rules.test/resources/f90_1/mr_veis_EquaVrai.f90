...
! Modules
! =======
use int_rep_fondamentaux, only : mr_veis_TerVrai
...
character(len=pm_longueur_info_utilisateur), parameter :: info_utilisateur = &
                     '@(#) Fichier MSLIB mr_veis_EquaVrai.f90: derniere modification V6.13 >'

! Ne pas toucher a la ligne suivante
character(len=pm_longueur_rcs_id), parameter :: rcs_id =' $Id: mr_veis_EquaVrai.f90 362 2013-02-15 18:01:28Z bbjc $ '
