...
!   + Version 6.8 : DM-ID 616 : utilisation de matmul3
...
character(len=pm_longueur_info_utilisateur), parameter :: info_utilisateur = &
                     '@(#) Fichier MSLIB mri_eclip_vrai_t1_t2.f90: derniere modification V6.13 >'

intrinsic cos, sin

! Ne pas toucher a la ligne suivante
character(len=pm_longueur_rcs_id), parameter :: rcs_id =' $Id: mri_eclip_vrai_t1_t2.f90 362 2013-02-15 18:01:28Z bbjc $ '
