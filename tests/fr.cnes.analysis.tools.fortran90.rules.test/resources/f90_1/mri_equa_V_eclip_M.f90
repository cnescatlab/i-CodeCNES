...
!************************************************************************
!
! But:  Calcul de la matrice de passage du repere EQUAtorial VRAI a T1 au repere ECLIPtique MOYen a T2.
! ===
!
...
!$Historique
! ==========
!   + Version 1.0 (SP 270 ed01 rev00): creation a partir de la routine MRQCVM de la MSLIB f77
...
!   + Version 6.8 : DM-ID 616 : utilisation de transpose3
...
character(len=pm_longueur_info_utilisateur), parameter :: info_utilisateur = &
                     '@(#) Fichier MSLIB mri_equa_V_eclip_M.f90: derniere modification V6.13 >'

! Ne pas toucher a la ligne suivante
character(len=pm_longueur_rcs_id), parameter :: rcs_id =' $Id: mri_equa_V_eclip_M.f90 362 2013-02-15 18:01:28Z bbjc $ '
...
if (model == pm_lieske_wahr) then ! calcul de la matrice de passage du repere equatorial vrai a t1 au repere ecliptique moyen a t2
   ...
   call mri_eclip_M_equa_V (model, jul1950_t2, jul1950_t1, mat_pass1, retour)
