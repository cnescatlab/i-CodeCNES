...
!************************************************************************
!
! But:  Calcul du produit vecteur-matrice transposee T(3)*(3,3)
! ===   
!
...
character(len=pm_longueur_info_utilisateur), parameter :: info_utilisateur = &
                     '@(#) Fichier MSLIB mu_mulvecttrans3.f90: derniere modification V6.13 >'

! Ne pas toucher a la ligne suivante
character(len=pm_longueur_rcs_id), parameter :: rcs_id =' $Id: mu_mulvecttrans3.f90 362 2013-02-15 18:01:28Z bbjc $ '
...
vect3_res(1)= mat33(1,1)*vect3(1)+mat33(2,1)*vect3(2)+mat33(3,1)*vect3(3)
vect3_res(2)= mat33(1,2)*vect3(1)+mat33(2,2)*vect3(2)+mat33(3,2)*vect3(3)
vect3_res(3)= mat33(1,3)*vect3(1)+mat33(2,3)*vect3(2)+mat33(3,3)*vect3(3)

code_retour%routine = pm_num_mu_mulvecttrans3
