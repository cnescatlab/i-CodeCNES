...
!***********************************************************************
!                                                                      *
! But: Produit scalaire de deux vecteurs de dimension 5                *
...
!
  character(len=pm_longueur_info_utilisateur), parameter :: info_utilisateur = &
       '@(#) Fichier MSLIB mui_dot_product5.f90: derniere modification V6.13 >'
!
! Ne pas toucher a la ligne suivante
  character(len=pm_longueur_rcs_id), parameter :: rcs_id = &
       ' $Id: mui_dot_product5.f90 362 2013-02-15 18:01:28Z bbjc $ '
!
!************************************************************************
