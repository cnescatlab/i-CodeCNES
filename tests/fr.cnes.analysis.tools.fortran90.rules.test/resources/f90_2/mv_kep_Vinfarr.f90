...
! ===  hyperboliques a vitesse infinie d arrivee
!
! Note d'utilisation:  
! ==================
!
...
real(pm_reel) :: DLA_tmp, RLA_tmp                   ! valeurs temporaires des parametres Vinfarr
...
character(len=pm_longueur_info_utilisateur), parameter :: info_utilisateur = &
     '@(#) Fichier MSPRO mv_kep_Vinfarr.f90: derniere modification V5.15 >'
...
Vinfarr%RLA = modulo(RLA_tmp, pm_deux_pi)

! Rayon du periastre
! ------------------

Vinfarr%Rp = kep%a*(kep%e - 1._pm_reel) ! avec e - 1 > 0
...
code_retour%routine = pm_num_mv_kep_Vinfarr
