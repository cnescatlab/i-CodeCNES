...
!
!$Resume
!  Utilitaire pour le fonctionnement du modèle d'atmosphère EMCD431
!
!$Description
!  Utilitaire pour le fonctionnement du modèle d'atmosphère EMCD431
!
!$Usage
!.     ui_atm_emcd431 -choice_date choice_date -localtime localtime 
...
!
!$Version
!  $Id: ui_atm_emcd431.F90 355 2013-02-14 12:16:41Z aadt $
!
!$Historique
!  $Log: ui_atm_emcd431.F90,v $
!  Revision 355  2013/02/14 aadt
!  DM-ID 1513: Suppression des warnings de compilation
!
!  Revision 1.6  2010/11/03 10:50:58  mercadig
!  VERSION::FA-ID:1443:03/11/2010:Correction des formats
!
!  Revision 1.5  2010/11/02 16:16:16  mercadig
!  VERSION::FA-ID:1443:02/11/2010:Unites manquantes et homogeneisation de la presentation
!
!  Revision 1.4  2010/10/21 13:46:22  ogarat
...
!
!  Revision 1.1.2.1  2010/03/03 13:16:36  cmartel
!  V2.9::DM-ID:1360:02/03/2010:Ajout de l'utilitaire du modele EMCD 4.3.1
!
!
!$FinHistorique
!
...
! SVN Source File Id
  ...
  if ( MSP_gen_messages("ui_atm_emcd431") ) then
  ...
  ! lecture effective
  if(ierfin.eq.1) then
     call ui_ecrire_help("ui_atm_emcd431")
     goto 999
...
!
!$Resume
!  Conversion des données d'entrée au format demandé par cps_atmemcd_431
!
!$Description
!  Conversion des données d'entrée au format demandé par cps_atmemcd_431
!
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    if (choice_date.eq.'e') then 
       ...
       ! Appel à la méthode de du module cps_modele_emcd431
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    integer, INTENT(IN) :: ier ! call_mcd status (=0 if all went well)
      ...
      if (ier.eq.0) then
         ...
         write(0,'(a)')'Erreur dans cps_atmemcd_431'
         write(0,'(a,i2)')'         code retour : ', ier
      end if

  end subroutine affichage_resultats

end program ui_atm_emcd431
