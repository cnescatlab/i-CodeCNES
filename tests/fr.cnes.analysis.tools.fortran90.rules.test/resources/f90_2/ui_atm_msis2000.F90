...
!
!$Resume
!  Programme de calcul du modèle d'atmosphère MSIS2000
!
!$Description
!  Programme de calcul du modèle d'atmosphère MSIS2000
!  Utilise cps_calculer_msis2000 de cps_atmosphere.F90
!
! Usage
!.     ui_atm_msis2000 -jour jour -sec sec
...
!. ou
!.    ui_atm_msis2000 -fic fichier_contenant_la_sequence_d_appel 
!
!
...
!
!$Version
!  $Id: ui_atm_msis2000.F90 355 2013-02-14 12:16:41Z aadt $
!
!$Historique
!  $Log: ui_atm_msis2000.F90,v $
...
!
!  Revision 1.9  2010/11/02 14:23:33  mercadig
!  VERSION::FA-ID:1443:02/11/2010:Unites manquantes et homogeneisation de la presentation
!
...
!
!  Revision 1.1  2007/10/30 11:09:20  sbd
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  use ui_io
  use cps_atmosphere
!  fonction :  cps_calculer_msis2000
  use cps_acces
...
! initialisation
  ...
  if ( MSP_gen_messages("ui_atm_msis2000") ) then
...
! Lecture des paramètres (en ligne ou sur fichier)
  ...
  call ui_test_arguments ("-h", "-fic", ierfin)
      ...
      ! lecture effective
      if(ierfin.eq.1) then
         call ui_ecrire_help("ui_atm_msis2000")
         goto 999
...
! Initialisations preliminaires
      ...
      if(logjour.and.loglat.and.logsec.and.logalt.and.logflux_veille &
         ...
         ! appel effectif
         call cps_calculer_msis2000 (date,flux_veille,flux_3rot,tab_ap,lat,long,alt, &
