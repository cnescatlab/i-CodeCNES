...
!
!$Resume
!  Programme de calcul du modèle d'atmosphère MSIS86
!
!$Description
!  Programme de calcul du modèle d'atmosphère MSIS86
!
! Usage
!.     ui_atm_msis86 -jour jour -sec sec -flux_veille flux_veille -flux_3rot flux_3rot 
!.                   -lat lat -long long -alt alt -heure heure_sol
...
!
!$Version
!  $Id: ui_atm_msis86.F90 355 2013-02-14 12:16:41Z aadt $
!
!$Historique
!  $Log: ui_atm_msis86.F90,v $
!  Revision 355  2013/02/14 aadt
!  DM-ID 1513: Suppression des warnings de compilation
!
!  Revision 1.20  2010/11/02 16:16:17  mercadig
!  VERSION::FA-ID:1443:02/11/2010:Unites manquantes et homogeneisation de la presentation
!
!  Revision 1.19  2010/11/02 14:23:37  mercadig
!  VERSION::FA-ID:1443:02/11/2010:Unites manquantes et homogeneisation de la presentation
!
...
!
!  Revision 1.8  2006/10/18 09:53:47  vivaresf
!  DM-ID 425 : Cloture du FT (Passage PSIMU sous Linux)
!
!  Revision 1.7.2.1  2006/09/26 12:15:37  vpg
!  DM-ID 425 : Version initiale du FT (Passage PSIMU sous Linux)
!
!  Revision 1.7  2006/08/30 08:55:34  vivaresf
...
!
!  Revision 1.3  2006/03/23 17:10:08  bouillaj
!  Amelioration qualite
!
!  Revision 1.2  2006/02/10 10:26:30  bouillaj
...
!>  inv_haut_ech     : <pm_reel>          inerse de la hauteur d'échelle (m)
...
! entrées/sorties
  ...
  real(kind=pm_reel) :: inv_haut_ech 
...
! initialisation
  ...
  if ( MSP_gen_messages("ui_atm_msis86") ) then
...
! Lecture des paramètres (en ligne ou sur fichier)
  ...
  call ui_test_arguments ("-h", "-fic", ierfin)
      ...
      ! lecture effective
      if(ierfin.eq.1) then
         call ui_ecrire_help("ui_atm_msis86")
         goto 999
...
! Initialisations preliminaires
      ...
      if(logjour.and.loglat.and.logsec.and.logalt.and.logflux_veille &
       ...
       dens,code_retour,temp=temp,pres=pres,inv_haut_ech=inv_haut_ech)
