...
package fr.cnes.analysis.tools.fortran90.rules.COM.DATA.NotUsed;
...
import fr.cnes.analysis.tools.fortran90.rules.COMDATANotUsed;
...
public class TestCOMDATANotUsed {
    ...
    public final static int[] LINES = {7, 12};
