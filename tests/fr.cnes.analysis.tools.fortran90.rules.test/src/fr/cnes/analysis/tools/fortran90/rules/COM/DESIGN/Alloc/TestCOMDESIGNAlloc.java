...
package fr.cnes.analysis.tools.fortran90.rules.COM.DESIGN.Alloc;
...
import fr.cnes.analysis.tools.fortran90.rules.COMDESIGNAlloc;
 ...
 * 
 */
public class TestCOMDESIGNAlloc {

    public final static String ERROR_FILE = "error.f";
    public final static String NO_ERROR_FILE = "noError.f";
    public final static int[] LINES = {12, 17};
    public final static String[] LOCATIONS = {"procedure p1",
            "subroutine s2"};
    public final AbstractRule rule = new COMDESIGNAlloc();
