...
package fr.cnes.analysis.tools.fortran90.rules.COM.INST.Brace;
...
import fr.cnes.analysis.tools.fortran90.rules.COMINSTBrace;
...
public class TestCOMINSTBrace {
	...
	public final static int[] LINES = { 5, 6, 7, 26, 27, 27 };
	public final static String[] LOCATIONS = { "PROGRAM ESSAI", "PROGRAM ESSAI", "PROGRAM ESSAI", "PROGRAM ESSAI", "PROGRAM ESSAI", "PROGRAM ESSAI" };
