...
package fr.cnes.analysis.tools.fortran90.rules.COM.INST.LoopCondition;
...
import fr.cnes.analysis.tools.fortran90.rules.COMINSTLoopCondition;
...
public class TestCOMINSTLoopCondition {
	...
	public final static int[] LINES = { 5, 11 };
	public final static String[] LOCATIONS = { "PROGRAM ESSAI", "PROGRAM ESSAI" };
	public final AbstractChecker rule = new COMINSTLoopCondition();
	...
	public void testRunWithError() {
		...
		try {
			...
			fail("Erreur d'analyse (JFlexException) " + e.getMessage());
		}
	}
