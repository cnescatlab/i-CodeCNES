...
package fr.cnes.analysis.tools.fortran90.rules.COM.PRES.Indent;
...
import fr.cnes.analysis.tools.fortran90.rules.COMPRESIndent;
...
public class TestCOMPRESIndent {
    ...
    public final static int[] LINES = {5, 6};
    public final static String[] LOCATIONS =
            {"PROGRAM ESSAI", "PROGRAM ESSAI"};
    public AbstractRule rule = new COMPRESIndent();
