...
PROGRAM ESSAI 
      ...
      real(DOUBLE) :: x1 = 0.1
! !!! Regle 'Don.ConstFlottant' pas respectee ci-dessus, la precision de la constante n'etant pas precisee
! !!!    la valeur resultante est en simple precision alors que la variable a ete prevue pour de la double precision 
