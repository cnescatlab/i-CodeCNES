...
package fr.cnes.analysis.tools.fortran90.rules.F90.DATA.Parameter;
...
import fr.cnes.analysis.tools.fortran90.rules.F90DATAParameter;
...
public class TestF90DATAParameter {
    ...
    public final static String[] LOCATIONS = {"MAIN PROGRAM", "MAIN PROGRAM",
            ...
            "PROGRAM ESSAI", "PROGRAM ESSAI", "PROGRAM ESSAI"};
    public final AbstractRule rule = new F90DATAParameter();
