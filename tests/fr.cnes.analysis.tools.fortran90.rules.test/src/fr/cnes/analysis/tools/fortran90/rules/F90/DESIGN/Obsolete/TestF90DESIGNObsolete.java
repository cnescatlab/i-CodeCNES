...
package fr.cnes.analysis.tools.fortran90.rules.F90.DESIGN.Obsolete;
...
import fr.cnes.analysis.tools.fortran90.rules.F90DESIGNObsolete;
import fr.cnes.analysis.tools.fortran90.rules.TestUtils;

/**
 * This class aims to test Tr.Entry rule. There are 2 functions in this class.
 ...
 * 
 */
public class TestF90DESIGNObsolete {

    public final static String ERROR_FILE = "error.f";
    public final static String NO_ERROR_FILE = "noError.f";
    public final static int[] LINES = {8,78,79,92,115,123,124,176,183,191};
    public final static String[] LOCATIONS = {"function RETOURNE","PROGRAM ESSAI","PROGRAM ESSAI","PROGRAM ESSAI",
            "PROGRAM ESSAI", "PROGRAM ESSAI", "function RETOURNE","PROGRAM ESSAI","PROGRAM ESSAI",
            "PROGRAM ESSAI"};
    public final AbstractRule rule = new F90DESIGNObsolete();
    ...
    public void testRunWithError() {
        ...
        try {
            ...
            final IPath file =
                    new Path(this.getClass().getResource(ERROR_FILE).getPath());
            ...
            final String fileName =
                    list.get(0).getFilePath().toFile().getName();
    ...
    public void testRunWithoutError() {
        try {
            // Initializing rule and getting error file.
            final IPath file =
                    new Path(this.getClass().getResource(NO_ERROR_FILE)
                            .getPath());
            ...
            assertTrue(
                    "Error(s) are detected : " + TestUtils.getViolations(list),
                    list.isEmpty());
