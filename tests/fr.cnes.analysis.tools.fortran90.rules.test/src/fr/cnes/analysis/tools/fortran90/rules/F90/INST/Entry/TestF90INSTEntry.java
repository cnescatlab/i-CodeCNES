...
package fr.cnes.analysis.tools.fortran90.rules.F90.INST.Entry;
...
import fr.cnes.analysis.tools.fortran90.rules.F90INSTEntry;
 ...
 * 
 */
public class TestF90INSTEntry {

    public final static String ERROR_FILE = "error.f";
    public final static String NO_ERROR_FILE = "noError.f";
    public final static int[] LINES = {10, 16};
    public final static String[] LOCATIONS = {"SUBROUTINE FIN",
            "SUBROUTINE FIN"};
    public final AbstractRule rule = new F90INSTEntry();
