...
package fr.cnes.analysis.tools.fortran90.rules.F90.INST.Intent;
...
import fr.cnes.analysis.tools.fortran90.rules.F90INSTIntent;
 ...
 * 
 */
public class TestF90INSTIntent {

	public final static String ERROR_FILE = "error.f90";
	public final static String NO_ERROR_FILE = "noError.f90";
	public final static int[] LINES = { 38, 39, 40 };
	public final static String[] LOCATIONS = { "subroutine Mouv", "subroutine Mouv", "subroutine Mouv" };
	public final AbstractChecker rule = new F90INSTIntent();
