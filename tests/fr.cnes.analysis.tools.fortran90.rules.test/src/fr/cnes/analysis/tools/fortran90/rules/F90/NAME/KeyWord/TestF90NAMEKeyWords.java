...
package fr.cnes.analysis.tools.fortran90.rules.F90.NAME.KeyWord;
 ...
 * 
 */
public class TestF90NAMEKeyWords {
    ...
    public final static String[] LOCATIONS = {"PROGRAM ESSAI", "PROGRAM ESSAI", "PROGRAM ESSAI",
    										  "PROGRAM ESSAI", "PROGRAM ESSAI", "FUNCTION sin"};
