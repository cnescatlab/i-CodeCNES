...
PROGRAM ESSAI 
      ...
      interface operator (+)
         type(vecteur) function ajouter_vecteur_2(v1,v2) result (v3)
            USE t_vecteur
            implicit NONE
            type (vecteur), intent(in) :: v1,v2
         end function ajouter_vecteur_2
      end interface
...
! --- On peut utiliser aussi la surcharge d'operateur et on obtient le meme resultat 
      c = a + b
      print *, ' --- Addition de deux vecteurs (c=a+b+(a*b)) avec surcharge d''operateur --'
      print *, 'a=', a
      print *, 'b=', b
      print *, 'c=', c
...
! *******************************************************************************
! Cette fonction effectue l'operation d'addition 'amelioree' telle que c = a+b+ab
!    sur deux vecteurs de type 'vecteur' et retourne le resultat obtenu sous 
!    forme d'un vecteur 
! *******************************************************************************
type(vecteur) function ajouter_vecteur(v1,v2) result (v3)
