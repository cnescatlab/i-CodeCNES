...
package fr.cnes.analysis.tools.fortran90.rules.F90.REF.Label;
...
import fr.cnes.analysis.tools.fortran90.rules.F90REFLabel;
 ...
 * 
 */
public class TestF90REFLabel {

    public final static String ERROR_FILE = "error.f90";
    public final static String NO_ERROR_FILE = "noError.f90";
    public final static int[] LINES = {15, 43, 61, 84, 145};
    public final static String[] LOCATIONS = {"module ma_precision", "block data bloc_mesure", "subroutine celsius_to_fahrenheit",
            "function mon_getuid", "program essai"};
    public final AbstractRule rule = new F90REFLabel();
