...
package fr.cnes.analysis.tools.fortran90.rules.F90.REF.Variable;
...
import fr.cnes.analysis.tools.fortran90.rules.F90REFVariable;
import fr.cnes.analysis.tools.fortran90.rules.TestUtils;

/**
 * This class aims to test Int.ParamOpen rule. There are 2 functions in this
 ...
 * 
 */
public class TestF90REFVariable {

	public final static String ERROR_FILE = "error.f90";
	public final static String NO_ERROR_FILE = "noError.f90";
	public final static int[] LINES = { 19, 19 };
	public final static String[] LOCATIONS = { "subroutine incr", "subroutine incr" };
	public final AbstractChecker rule = new F90REFVariable();
