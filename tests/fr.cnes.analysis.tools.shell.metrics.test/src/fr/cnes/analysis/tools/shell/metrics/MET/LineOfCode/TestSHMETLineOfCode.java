...
public class TestSHMETLineOfCode {
    ...
    public void testRunWithError() {
        ...
        try {
            ...
            final AbstractMetric metric = new SHMETLineOfCode();
            ...
            assertTrue(fileValue.getFile().getName()
                    .equals(fileName));
            assertTrue(fileValue.getValue() == 82.0);
            ...
            assertTrue(metricValue.getLocation().equals(
                    "search_base_dir"));
            assertTrue(metricValue.getValue() == 13.0);
            
            // Value 3
            metricValue = functionValues.get(2);
            assertTrue(metricValue.getLocation().equals(
                    "verify_process"));
            assertTrue(metricValue.getValue() == 6.0);
            
            // Value 4
            metricValue = functionValues.get(3);
            assertTrue(metricValue.getLocation().equals(
                    "MAIN PROGRAM"));
            assertTrue(metricValue.getValue() == 60.0);
