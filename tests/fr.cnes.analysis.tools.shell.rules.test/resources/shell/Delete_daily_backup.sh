...
#			LOGDELETE=/GFS_GBIN/tests/testTar/tBackup/Backup/log/${FILETYPE}_$param.del

                        LOGDELETE=/GFS_SAGA/DPCCTools/TarTools/log/DailyBackup/${FILETYPE}_$param.del
                 ...
                 if [ -f $LOGDELETE ]; then
                        ...
                        echo -e "\n********************* Working Directories  *****************\n" | tee -a $LOGDELETE
                        echo "'cd'/GFS_BACKUP/Aspera/OPS/reception/daily/backup" | tee -a $LOGDELETE
                        echo "'LOGFILE:'/GFS_SAGA/DPCCTools/TarTools/log/DailyBackup/${FILETYPE}_$param.log" | tee -a $LOGDELETE
                        echo "'ERRORFILE:'/GFS_SAGA/DPCCTools/TarTools/log/DailyBackup/${FILETYPE}_$param.err" | tee -a $LOGDELETE
