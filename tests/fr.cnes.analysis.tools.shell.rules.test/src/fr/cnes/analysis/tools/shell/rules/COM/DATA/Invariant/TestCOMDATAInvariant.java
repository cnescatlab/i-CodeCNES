...
package fr.cnes.analysis.tools.shell.rules.COM.DATA.Invariant;
...
import fr.cnes.analysis.tools.shell.rules.COMDATAInvariant;
 ...
 * 
 */
public class TestCOMDATAInvariant {
    ...
    public final static String[] LOCATIONS = {"MAIN PROGRAM","MAIN PROGRAM","fonction","MAIN PROGRAM","fonction2","MAIN PROGRAM","MAIN PROGRAM"};
    public final AbstractRule rule = new COMDATAInvariant();
