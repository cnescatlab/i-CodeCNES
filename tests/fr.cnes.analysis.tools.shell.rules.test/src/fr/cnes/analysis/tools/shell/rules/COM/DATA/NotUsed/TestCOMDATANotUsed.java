...
package fr.cnes.analysis.tools.shell.rules.COM.DATA.NotUsed;
...
import fr.cnes.analysis.tools.shell.rules.COMDATANotUsed;
...
public class TestCOMDATANotUsed {
    ...
    public final AbstractRule rule = new COMDATANotUsed();
