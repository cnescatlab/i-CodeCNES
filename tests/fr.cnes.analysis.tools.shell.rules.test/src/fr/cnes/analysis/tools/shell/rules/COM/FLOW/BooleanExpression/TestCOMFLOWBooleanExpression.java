...
package fr.cnes.analysis.tools.shell.rules.COM.FLOW.BooleanExpression;
...
import fr.cnes.analysis.tools.shell.rules.COMFLOWBooleanExpression;
 ...
 * 
 */
public class TestCOMFLOWBooleanExpression {

    public final static String ERROR_FILE = "error.sh";
    public final static String NO_ERROR_FILE = "noError.sh";
    public final static int[] LINES = {12, 17, 27, 32, 34, 42, 47};
    public final static String[] LOCATIONS = {"test_func", "test_func", "test_func2", "test_func2", "test_func2", "test_func2", "test_func2"};
    public final AbstractRule rule = new COMFLOWBooleanExpression();
