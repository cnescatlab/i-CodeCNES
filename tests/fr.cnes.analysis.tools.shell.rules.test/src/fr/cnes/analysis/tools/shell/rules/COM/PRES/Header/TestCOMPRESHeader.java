...
package fr.cnes.analysis.tools.shell.rules.COM.PRES.Header;
...
import fr.cnes.analysis.tools.shell.rules.COMPRESHeader;
 ...
 * 
 */
public class TestCOMPRESHeader {

    public final static String ERROR_FILE = "error.sh";
    public final static String NO_ERROR_FILE = "noError.sh";
    public final static int[] LINES = {12,25};
    public final static String[] LOCATIONS = {"ma_fonction_affine", "affiche_resultat"};
    public final AbstractRule rule = new COMPRESHeader();
