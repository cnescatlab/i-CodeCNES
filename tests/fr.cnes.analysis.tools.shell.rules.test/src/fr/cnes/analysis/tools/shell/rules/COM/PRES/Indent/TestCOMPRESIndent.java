...
package fr.cnes.analysis.tools.shell.rules.COM.PRES.Indent;
...
import fr.cnes.analysis.tools.shell.rules.COMPRESIndent;
 ...
 * 
 */
public class TestCOMPRESIndent {
    ...
    public final static String[] LOCATIONS = {"ma_fonction_affine", "ma_fonction_affine", "affiche_resultat", "affiche_resultat", "affiche_resultat", "affiche_resultat", "affiche_resultat", "affiche_resultat", "affiche_resultat", "affiche_resultat"};
    public final AbstractRule rule = new COMPRESIndent();
