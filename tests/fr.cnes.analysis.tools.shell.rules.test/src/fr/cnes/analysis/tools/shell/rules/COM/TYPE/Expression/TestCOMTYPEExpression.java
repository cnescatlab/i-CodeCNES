...
package fr.cnes.analysis.tools.shell.rules.COM.TYPE.Expression;
...
import fr.cnes.analysis.tools.shell.rules.COMTYPEExpression;
...
public class TestCOMTYPEExpression {
    ...
    public final static int[] LINES = {9,13};
