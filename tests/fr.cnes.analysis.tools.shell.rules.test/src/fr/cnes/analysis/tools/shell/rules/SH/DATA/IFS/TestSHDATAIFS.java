...
package fr.cnes.analysis.tools.shell.rules.SH.DATA.IFS;
...
import fr.cnes.analysis.tools.shell.rules.SHDATAIFS;
...
public class TestSHDATAIFS {
    ...
    public final AbstractRule rule = new SHDATAIFS();
