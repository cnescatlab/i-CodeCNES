...
package fr.cnes.analysis.tools.shell.rules.SH.DATA.Integer;
...
import fr.cnes.analysis.tools.shell.rules.SHDATAInteger;
 ...
 * 
 */
public class TestSHDATAInteger {
    ...
    public final AbstractRule rule = new SHDATAInteger();
