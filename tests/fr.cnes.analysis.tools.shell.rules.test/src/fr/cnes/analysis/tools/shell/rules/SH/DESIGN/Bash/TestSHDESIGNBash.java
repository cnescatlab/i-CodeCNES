...
package fr.cnes.analysis.tools.shell.rules.SH.DESIGN.Bash;
...
import fr.cnes.analysis.tools.shell.rules.SHDESIGNBash;
...
public class TestSHDESIGNBash {
    ...
    public final AbstractRule rule = new SHDESIGNBash();
