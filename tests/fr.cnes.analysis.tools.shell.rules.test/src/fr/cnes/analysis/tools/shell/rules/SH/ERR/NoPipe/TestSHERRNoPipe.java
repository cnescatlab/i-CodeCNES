...
package fr.cnes.analysis.tools.shell.rules.SH.ERR.NoPipe;
...
import fr.cnes.analysis.tools.shell.rules.SHERRNoPipe;
...
public class TestSHERRNoPipe {
    ...
    public final AbstractRule    rule          = new SHERRNoPipe();
