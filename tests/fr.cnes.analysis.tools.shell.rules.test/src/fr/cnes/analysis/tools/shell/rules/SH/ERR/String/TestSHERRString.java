...
package fr.cnes.analysis.tools.shell.rules.SH.ERR.String;
...
import fr.cnes.analysis.tools.shell.rules.SHERRString;
...
public class TestSHERRString {
    ...
    public final AbstractRule rule = new SHERRString();
