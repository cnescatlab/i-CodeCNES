...
package fr.cnes.analysis.tools.shell.rules.SH.INST.Continue;
...
import fr.cnes.analysis.tools.shell.rules.SHINSTContinue;
 ...
 * 
 */
public class TestSHINSTContinue {
    ...
    public final AbstractRule rule = new SHINSTContinue();
