...
package fr.cnes.analysis.tools.shell.rules.SH.INST.GetOpts;
 ...
 * 
 */
public class TestSHINSTGetOpts {
    ...
    public final static String[] LOCATIONS     = { "direct_calls", "direct_calls", "direct_calls",
                "direct_calls", "direct_calls", "direct_calls", "MAIN PROGRAM" };
