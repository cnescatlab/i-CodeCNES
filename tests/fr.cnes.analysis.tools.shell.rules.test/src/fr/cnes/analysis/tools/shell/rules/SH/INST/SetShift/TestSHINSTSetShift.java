...
package fr.cnes.analysis.tools.shell.rules.SH.INST.SetShift;
...
import fr.cnes.analysis.tools.shell.rules.SHINSTSetShift;
 ...
 * 
 */
public class TestSHINSTSetShift {

    public final static String ERROR_FILE = "error.sh";
    public final static String NO_ERROR_FILE = "noError.sh";
    public final static int[] LINES = {16, 27, 27, 28, 41, 42, 46};
    public final static String[] LOCATIONS = {"MAIN PROGRAM", "getopts_internal", "getopts_internal", 
    										  "getopts_internal", "getopts_internal", "getopts_internal", 
    										  "getopts_internal"};
    public final AbstractRule rule = new SHINSTSetShift();
