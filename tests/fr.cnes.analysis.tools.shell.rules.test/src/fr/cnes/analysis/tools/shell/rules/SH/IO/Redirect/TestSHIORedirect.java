...
package fr.cnes.analysis.tools.shell.rules.SH.IO.Redirect;
...
import fr.cnes.analysis.tools.shell.rules.SHIORedirect;
import fr.cnes.analysis.tools.shell.rules.TestUtils;

/**
 * This class aims to test SHIORedirect rule. There are 2 functions in this
...
public class TestSHIORedirect {
    ...
    public final static String[] LOCATIONS     = { "MAIN PROGRAM", "MAIN PROGRAM", "MAIN PROGRAM",
                "MAIN PROGRAM", "MAIN PROGRAM" };
    public final AbstractRule    rule          = new SHIORedirect();
