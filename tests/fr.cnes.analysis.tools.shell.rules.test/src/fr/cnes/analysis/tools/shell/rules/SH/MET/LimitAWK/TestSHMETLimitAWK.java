...
package fr.cnes.analysis.tools.shell.rules.SH.MET.LimitAWK;
...
import fr.cnes.analysis.tools.shell.rules.SHMETLimitAWK;
 ...
 * 
 */
public class TestSHMETLimitAWK {
    ...
    public final AbstractRule rule = new SHMETLimitAWK();
