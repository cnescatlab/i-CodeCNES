...
package fr.cnes.analysis.tools.shell.rules.SH.MET.PipeLine;
...
import fr.cnes.analysis.tools.shell.rules.SHMETPipeLine;
 ...
 * 
 */
public class TestSHMETPipeLine {
    ...
    public final AbstractRule rule = new SHMETPipeLine();
