...
package fr.cnes.analysis.tools.shell.rules.SH.REF.Export;
...
import fr.cnes.analysis.tools.shell.rules.SHREFExport;
...
public class TestSHREFExport {
    ...
    public final AbstractRule rule = new SHREFExport();
