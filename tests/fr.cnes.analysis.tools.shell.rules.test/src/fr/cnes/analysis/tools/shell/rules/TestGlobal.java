...
public class TestGlobal {
  ...
  final String                  ruleExtensionId = "fr.cnes.analysis.tools.shell.rule";
  ...
  public void runGlobalTest() {
    try {
      ...
      TestGlobal.list = analysis.applyRules(listFiles, extensionIds, null);
  ...
  private void createExportFile(File fileResult) {
    try {
      ...
      /** Only one error -> print directly **/
        ...
        ruleOutput.write(list.get(0).getRuleName() + " "
